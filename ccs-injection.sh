...
parse_hn_port() {
	PORT="$2"       # unless otherwise auto-determined, see below
	NODE="$1"
...
#### main TLS1.0 ####
echo "######## CCS Injection Check with TLS 1.0 ########"
...
#### main TLS1.1 ####                                                                                                                                      
echo "######## CCS Injection Check with TLS 1.1 ########"   
...
#### main TLS1.2 ####                                                                                                                                      
echo "######## CCS Injection Check with TLS 1.2 ########"   
